...
- 从 [Releases](https://github.com/QinWenYan1/KopiRPC/releases) 下载 `KopiRPC-0.1.0.tar.gz`(静态库 + 头文件 + 使用文档);集成方法与最小示例见 [docs/usage.md](docs/usage.md)。
...
- ~~[x] 阶段3 出包发布(v0.1.0:tar.gz + 使用文档 + GitHub Release)~~

> ⚠️ 已知限制: 协议帧在 localhost 小消息场景验证;大消息/跨网络粘包半包未支持,见 roadmap 进阶方向。
