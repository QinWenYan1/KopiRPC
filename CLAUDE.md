...
The project is in the **theory-learning / pre-implementation phase** — no source code or build system exists yet. The planned technical direction (based on the reference article digested in `docs/01`):
